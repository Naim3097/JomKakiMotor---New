...
export const metadata: Metadata = {
  ...
  description:
    "Practical guides for Malaysian riders: trade-in process, financing documents, model comparisons and road tax renewal — written by the JomKaki Rider team.",
  ...
  return (
    <Section pad="tight">
      ...
      <div className="mt-10 max-w-3xl">
        ...
        <h1 className="display-1 mt-4 text-ink">The JomKaki Rider Blog</h1>
